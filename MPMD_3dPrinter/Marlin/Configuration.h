...
#define STRING_CONFIG_H_AUTHOR "(Keshuai)" // Who made the changes.
...
//	#define DELTA_RADIUS 63.90
	...
	#define DELTA_ENDSTOP_ADJ_Y -0.09
	#define DELTA_ENDSTOP_ADJ_Z -0.48
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {112.9, 112.9, 112.9, 97.00}  // default steps per unit for Ultimaker
